<?php
class Depan extends JI_Controller{
	...
	public function index(){
		...
		$this->setTitle('Login ke Pasien '.$this->site_suffix);
		...
		$this->putThemeContent("depan/home",$data); //pass data to view
		//this view for INPAGE JS Script can be found on app/view/front/page/home/home_bottom.php
		$this->putJsContent("depan/home_bottom",$data); //pass data to view
