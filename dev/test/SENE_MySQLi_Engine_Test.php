...
final class SENE_MySQLi_Engine_Test extends TestCase
{
  ...
  */
  ...
  public function testWhereIsNull()
  {
    ...
    $this->invokeMethod($tc, 'select', array('*'));
    $this->invokeMethod($tc, 'from', array('tabel'));
    $this->invokeMethod($tc, 'where', array('name','IS NULL', 'AND', ''));
    $this->assertEquals('`name`  IS NULL  AND ',$tc->in_where);
    ...
    $this->invokeMethod($tc, 'select', array('*'));
    $this->invokeMethod($tc, 'from', array('tabel'));
    $this->invokeMethod($tc, 'where', array('name','IS NULL', 'OR'));
    $this->assertEquals('`name`  IS NULL  OR ',$tc->in_where);
  ...
  public function testWhereIsNotNull()
  {
    ...
    $this->invokeMethod($tc, 'select', array('*'));
    $this->invokeMethod($tc, 'from', array('tabel'));
    $this->invokeMethod($tc, 'where', array('name','IS NOT NULL', 'AND', ''));
    $this->assertEquals('`name`  IS NOT NULL  AND ',$tc->in_where);
    ...
    $this->invokeMethod($tc, 'select', array('*'));
    $this->invokeMethod($tc, 'from', array('tabel'));
    $this->invokeMethod($tc, 'where', array('name','IS NOT NULL', 'OR'));
    $this->assertEquals('`name`  IS NOT NULL  OR ',$tc->in_where);
  ...
  public function testWhereAsIsNull()
  {
    ...
    $this->invokeMethod($tc, 'select', array('*'));
    $this->invokeMethod($tc, 'from', array('tabel'));
    $this->invokeMethod($tc, 'where_as', array('name','IS NULL', 'AND', ''));
    $this->assertEquals('name  IS NULL  AND ',$tc->in_where);
    ...
    $this->invokeMethod($tc, 'select', array('*'));
    $this->invokeMethod($tc, 'from', array('tabel'));
    $this->invokeMethod($tc, 'where_as', array('name','IS NULL', 'OR'));
    $this->assertEquals('name  IS NULL  OR ',$tc->in_where);
  ...
  public function testWhereAsIsNotNull()
  {
    ...
    $this->invokeMethod($tc, 'select', array('*'));
    $this->invokeMethod($tc, 'from', array('tabel'));
    $this->invokeMethod($tc, 'where_as', array('name','IS NOT NULL', 'AND', ''));
    $this->assertEquals('name  IS NOT NULL  AND ',$tc->in_where);
    ...
    $this->invokeMethod($tc, 'select', array('*'));
    $this->invokeMethod($tc, 'from', array('tabel'));
    $this->invokeMethod($tc, 'where_as', array('name','IS NOT NULL', 'OR'));
    $this->assertEquals('name  IS NOT NULL  OR ',$tc->in_where);
